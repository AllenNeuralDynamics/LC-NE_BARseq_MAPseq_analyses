...
good_cells <- read.csv("/data/barseq_780346_2025-06-13_12-00-00_processed_MAT2RDS_2026-05-28_17-50-51/BARseq/LC_visualQC_barcoded_cells_780346.csv", stringsAsFactors = FALSE)
