...
t_combined_norm_clean <- t_combined_norm[
  ...
  colSums(t_combined_norm) != 0,
  drop = FALSE
]

#perform NMF on projections data by calling the function
result_rank2 <- perform_nmf(t_combined_norm_clean, rank = 2, nrun = 20, seed = 12345)
result_rank3 <- perform_nmf(t_combined_norm_clean, rank = 3, nrun = 20, seed = 12345)
result_rank4 <- perform_nmf(t_combined_norm_clean, rank = 4, nrun = 20, seed = 12345)
