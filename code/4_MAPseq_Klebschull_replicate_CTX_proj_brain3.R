...
# Check for duplicates only based on counts entries ignoring the matadata head(full_proj_df)
exclude_cols <- c("slice", "CCF_AP", "CCF_DV", "CCF_ML", "inRH")
...
good_cells <- read.csv("/data/780345_2025-02-24_12-00-00_processed-MAT2RDS_2026-06-16_00-49-36/BARseq/LC_visualQC_barcoded_cells_780345.csv", stringsAsFactors = FALSE)
...
manual_final_selection <- c(
  ...
  "4_15_2041648.1" = "keep",
  "4_15_2050065.1" = "discard",
  "7_25_490685.1" = "discard",
  "7_25_600600.1" = "keep",
  "7_27_1920486.3" = "discard",
  "7_27_1920510.4" = "keep",
  "7_26_1150838.2" = "keep",
  "7_26_1260688.2" = "discard",
  "9_34_1150563.3" = "keep",
  "9_34_1260923.3" = "discard",
  "4_14_1262601.1" = "keep",
  ...
  "3_9_422479.2" = "keep",
  "3_9_430117.2" = "discard",
  "8_30_1170983.3" = "keep",
  "8_30_1281220.3" = "discard",
  "7_27_1941182.2" = "discard",
  "7_27_2051166.2" = "keep",
  "6_23_2161258.2" = "keep",
  "6_23_2271256.2" = "discard",
  "9_35_2030762.2" = "keep",
