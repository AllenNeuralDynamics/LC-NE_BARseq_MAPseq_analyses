...
region_map <- list(
  olf_bulb_contra = c("olf.bulb-contra.1", "olf.bulb-contra.2"),  
  AON_contra = c("AON-contra.3", "AON-contra.4"),  
  frontal_ctx_contra = c("orb.ctx-contra.4", "motor.ctx-contra.4"),  
  dorsal_ctx_contra = c("ctx.3-contra.5", "ctx.3-contra.6", "ctx.3-contra.7", "ctx.3-contra.8", "ctx.3-contra.9", "ctx.3-contra.10"),  
  middle_ctx_contra = c("ctx.2-contra.5", "ctx.2-contra.7", "ctx.2-contra.8", "ctx.2-contra.9", "ctx.2-contra.10"),  
  ventral_ctx_contra = c("ctx.1-contra.6", "ctx.1-contra.7", "ctx.1-contra.8", "ctx.1-contra.9", "ctx.1-contra.10"), 
  posterior_ctx_contra = c("ctx-contra.11"),
  corpus_callosum_contra = c("cc-contra.5", "cc-contra.7"),  
  striatum_contra = c("CPu-contra.5", "CPu-contra.7"),  
  NAc_contra = c("NAc-contra.6"),  
  septum_BNST_contra = c("septum-contra.6", "septum-contra.7", "BNST-contra.7"),  
  hippocampus_contra = c("hippocampus-contra.8", "hippocampus-contra.9", "hippocampus-contra.10"),  
  amygdala_contra = c("amygdala-contra.9"), 
  thalamus_contra = c("thalamus-contra.8", "thalamus-contra.9"),  
  hypothalamus_contra = c("hypothalamus-contra.8", "hypothalamus-contra.9"), 
  midbrain_contra = c("midbrain-contra.9", "midbrain-contra.10", "midbrain-contra.11"),  
  hindbrain_contra = c("hindbrain-contra.10", "hindbrain-contra.11"),  
  cerebellum_contra = c("cerebellum.I-contra.12", "cerebellum.II-contra.12"),
  medulla_contra = c("medulla-contra.12", "medulla-contra.13"), 
  
  olf_bulb_ipsi = c("olf.bulb-ipsi.1", "olf.bulb-ipsi.2"),  
  AON_ipsi = c("AON-ipsi.3", "AON-ipsi.4"), 
  frontal_ctx_ipsi = c("orb.ctx-ipsi.4", "motor.ctx-ipsi.4"),  
  dorsal_ctx_ipsi = c("ctx.3-ipsi.5", "ctx.3-ipsi.6", "ctx.3-ipsi.7", "ctx.3-ipsi.8", "ctx.3-ipsi.9", "ctx.3-ipsi.10"),  
  middle_ctx_ipsi = c("ctx.2-ipsi.5", "ctx.2-ipsi.7", "ctx.2-ipsi.8", "ctx.2-ipsi.9", "ctx.2-ipsi.10"),  
  ventral_ctx_ipsi = c("ctx.1-ipsi.6", "ctx.1-ipsi.7", "ctx.1-ipsi.8", "ctx.1-ipsi.9", "ctx.1-ipsi.10"), 
  posterior_ctx_ipsi = c("ctx-ipsi.11"),
  corpus_callosum_ipsi = c("cc-ipsi.5", "cc-ipsi.7"),  
  striatum_ipsi = c("CPu-ipsi.5", "CPu-ipsi.7"),  
  NAc_ipsi = c("NAc-ipsi.6"),  
  septum_BNST_ipsi = c("septum-ipsi.6", "septum-ipsi.7", "BNST-ipsi.7"),  
  hippocampus_ipsi = c("hippocampus-ipsi.8", "hippocampus-ipsi.9", "hippocampus-ipsi.10"),  
  amygdala_ipsi = c("amygdala-ipsi.9"),  
  thalamus_ipsi = c("thalamus-ipsi.8", "thalamus-ipsi.9"),  
  hypothalamus_ipsi = c("hypothalamus-ipsi.8", "hypothalamus-ipsi.9"),  
  midbrain_ipsi = c("midbrain-ipsi.9", "midbrain-ipsi.10", "midbrain-ipsi.11"),  
  hindbrain_ipsi = c("hindbrain-ipsi.10", "hindbrain-ipsi.11"),  
  cerebellum_ipsi = c("cerebellum.I-ipsi.12", "cerebellum.II-ipsi.12"), 
  medulla_ipsi = c("medulla-ipsi.12", "medulla-ipsi.13"),  
  
  spinal_cord_cervical = c("sp.cord.1_SP.14"), 
  spinal_cord_thoracic = c("sp.cord.2_SP.14", "sp.cord.3_SP.14")
)
...
biological_order <- c(
  ...
  "middle_ctx_contra", "ventral_ctx_contra", "posterior_ctx_contra", "corpus_callosum_contra", 
  ...
  "middle_ctx_ipsi", "ventral_ctx_ipsi","posterior_ctx_ipsi", "corpus_callosum_ipsi", 
